...
namespace AuthorCoreWebsiteTemplate.Controllers
{
    public class PostsController : Controller
    {
        ...
        public PostsController(AuthorCoreWebDbContext context)
        {
            _context = context;
        }
        ...
        {
            var authorCoreWebDbContext = _context.Posts.Include(p => p.Blog);
            return View(await authorCoreWebDbContext.ToListAsync());
        }
